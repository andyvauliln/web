...
const filterOptions = [
    ...
    { title: "Main Roads", value: "main_roads", color: "#303130", type: "map_layer", feature_type: "MapLine", className: "" },
    { title: "Secondary Roads", value: "secondary_roads", color: "#FFD700", type: "map_layer", feature_type: "MapLine", className: "" },
    { title: "Motorbike Roads", value: "motorbike_roads", color: "#FF6347", type: "map_layer", feature_type: "MapLine", className: "" },
    { title: "Transport Lines", value: "transport_lines", color: "#32cd32", type: "geojson_file", feature_type: "Line", className: "" },
    { title: "Waterways", value: "waterway", color: "white", type: "map_layer", feature_type: "MapLine", className: "border-b border-gray-500 pb-2" },
    // Special Areas
