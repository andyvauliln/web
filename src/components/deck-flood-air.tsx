...
const GOOGLE_MAPS_API_KEY = process.env.NEXT_PUBLIC_GOOGLE_MAP_API_KEY1;
...
const FLOOD_ZONE_DATA = "https://raw.githubusercontent.com/mepa1363/google-3d-tiles/bfa21935f90f84fa9fd5c8e077472e8d3b6614b6/public/tuflow_zones.geojson";
...
export default function DeckMap({ data = TILESET_URL, depth = 0 }) {
